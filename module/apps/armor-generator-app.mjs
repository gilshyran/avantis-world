export class AvantisArmorSmith extends Application {
    ...
    get armorData() {
        return {
            names: {
                ...
                torse: ["Plastron", "Tunique", "Manteau", "Veste","Harnois","Robe", "Cuirasse"],
                bras: ["Gantelets", "Protège-bras", "Brassards", "Gants"],
                jambes: ["Jambières", "Bottes", "Grèves", "Sandales", "Chausses"],
                integral: ["Tenue", "Robe", "Ensemble", "Combinaison","Uniforme","Harnois"]
            },
            adjectives: {
                q1: ["simple","de bataille", "de cuir","fiable","soigneusement conçu", "équilibré", "renforcé", "de soldat","équilibré","endurci","de patrouille","solide", "d'artisan"],
                q2: ["de qualité", "élégant","d'élite","de champion","de maître artisan","vénérable","mystique", "noble"],
                q3: ["orné", "de maître","transcendant","immuable", "supérieur","du Gardien","sacré", "runique"],
                q4: ["divin", "ancestral","infaillible","céleste","sublime","auguste", "du Héros","de légende", "éternel"]
            },
            ...
            masterBonuses: [
                "Coordination +1", "Expertise +1", "Ruse +1", "Commandement +1", 
                "Sagesse +1", "Empathie +1", "Volonté +1", "Persuasion +1", "Magnétisme", "Adaptation"
            ],
            properties: {
                ...
                "Constitution +1": "Augmente la défense Encaisser."
            },
    ...
    async _createItemInFoundry(html) {
        ...
        const basePath = "systems/avantis/icons/Protections/";
        let img = basePath + "tunique001.jpg"; // Image par défaut si rien ne matche
        
        const nameLower = d.name.toLowerCase();

        if (d.slot === 'tete') {
            if (nameLower.includes("capuche")) img = basePath + "capuche001.jpg";
            else if (nameLower.includes("masque")) img = basePath + "masque001.jpg";
            else if (nameLower.includes("couronne") || nameLower.includes("tiare") || nameLower.includes("cercle")) img = basePath + "couronne001.jpg";
            else if (nameLower.includes("diademe")) img = basePath + "diadème001.jpg";
            else if (nameLower.includes("heaume")) img = basePath + "heaume001.jpg";
            else img = basePath + "capuche001.jpg"; // Casque par défaut
        } 
        else if (d.slot === 'torse') {
            if (nameLower.includes("tunique") || nameLower.includes("veste") || nameLower.includes("poncho")) img = basePath + "tunique001.jpg";
            else if (nameLower.includes("manteau") || nameLower.includes("himation")) img = basePath + "ensemble001.jpg";
            else if (nameLower.includes("cuirasse")) img = basePath + "cuirasse001.jpg";
            else if (nameLower.includes("harnois")) img = basePath + "harnois001.jpg";
            else if (nameLower.includes("plastron")) img = basePath + "plastron001.jpg";
            else if (nameLower.includes("robe")) img = basePath + "robe001.jpg";
            else img = basePath + "tunique001.jpg"; // Plastron/Cuirasse par défaut
        } 
        else if (d.slot === 'bras') {
            if (nameLower.includes("gants")) img = basePath + "gants001.jpg";
            else if (nameLower.includes("Protège-bras")) img = basePath + "protege_bras001.jpg";
            else if (nameLower.includes("Brassards")) img = basePath + "brassard001.jpg";
            else img = basePath + "gantelets001.jpg"; // Gantelets par défaut
        } 
        else if (d.slot === 'jambes') {
            if (nameLower.includes("botte")) img = basePath + "botte001.jpg";
            else if (nameLower.includes("greve")) img = basePath + "greve001.jpg";
            else if (nameLower.includes("sandale")) img = basePath + "sandale001.jpg";
            else if (nameLower.includes("pantalon") || nameLower.includes("chausses")) img = basePath + "chausse001.jpg";
            else img = basePath + "jambieres001.jpg"; // Grèves/Jambières par défaut
        } 
        else if (d.slot === 'integral') {
            if (nameLower.includes("robe")) img = basePath + "robe001.jpg";
            else if (nameLower.includes("uniforme")) img = basePath + "uniforme001.jpg";
            else if (nameLower.includes("combinaison")) img = basePath + "combinaison001.jpg";
            else if (nameLower.includes("harnois")) img = basePath + "harnois001.jpg";
            else img = basePath + "tenue001.jpg"; // Tenue/Ensemble par défaut
        }
