export class AvantisWeaponForge extends Application {
    ...
    async _createItemInFoundry(html) {
        ...
        const basePath = "systems/avantis/icons/Armes/";

        // 2. Détection automatique de l'icône
        // Par défaut, on met une épée (assure-toi d'avoir un fichier epee.webp ou default.webp)
        let img = basePath + "epee_longue001.jpg"; 
        
        const lowerType = data.type.toLowerCase();

        if (lowerType.includes("arc")) img = basePath + "arc001.jpg";
        else if (lowerType.includes("atlatl")) img = basePath + "atlatl001.jpg";
        else if (lowerType.includes("bardiche")) img = basePath + "bardiche001.jpg";
        else if (lowerType.includes("arbal")) img = basePath + "arbalete001.jpg";
        else if (lowerType.includes("bolas")) img = basePath + "bolas001.jpg";
        else if (lowerType.includes("boomeran")) img = basePath + "boomerang001.jpg";
        else if (lowerType.includes("bouclier")) img = basePath + "bouclier001.jpg";
        else if (lowerType.includes("bâton")) img = basePath + "baton001.jpg";
        else if (lowerType.includes("cloutée")) img = basePath + "chaine_clouee001.jpg";
        else if (lowerType.includes("chaîne à deux")) img = basePath + "chaîne_à_deux_kamas001.jpg";
        else if (lowerType.includes("cimeterre")) img = basePath + "cimeterre001.jpg";
        else if (lowerType.includes("couteau de lancer")) img = basePath + "couteau_lancer001.jpg";
        else if (lowerType.includes("couteau")) img = basePath + "couteau001.jpg";
        else if (lowerType.includes("cracheur des")) img = basePath + "cracheur001.jpg";
        else if (lowerType.includes("double-lame")) img = basePath + "double_lame001.jpg";
        else if (lowerType.includes("courte")) img = basePath + "epee_courte001.jpg";
        else if (lowerType.includes("large")) img = basePath + "epee_large001.jpg";
        else if (lowerType.includes("longue")) img = basePath + "epee_longue001.jpg";
        else if (lowerType.includes("batarde")) img = basePath + "eppe_batarde001.jpg";
        else if (lowerType.includes("faux")) img = basePath + "faux001.jpg";
        else if (lowerType.includes("fléau")) img = basePath + "fleau001.jpg";
        else if (lowerType.includes("fouet")) img = basePath + "fouet001.jpg";
        else if (lowerType.includes("fronde")) img = basePath + "fronde001.jpg";
        else if (lowerType.includes("gourdin")) img = basePath + "gourdin001.jpg";
        else if (lowerType.includes("grand cracheur")) img = basePath + "grand_cracheur001.jpg";
        else if (lowerType.includes("grappin")) img = basePath + "grappin001.jpg";
        else if (lowerType.includes("hache de lancer")) img = basePath + "hache_lancer001.jpg";
        else if (lowerType.includes("hallebarde")) img = basePath + "hallebarde001.jpg";
        else if (lowerType.includes("javeline")) img = basePath + "javeline001.jpg";
        else if (lowerType.includes("jitte")) img = basePath + "jitte001.jpg";
        else if (lowerType.includes("wahaika")) img = basePath + "wahaika001.jpg";
        else if (lowerType.includes("urumi")) img = basePath + "urumi001.jpg";
        else if (lowerType.includes("tonfa")) img = basePath + "tonfa001.jpg";
        else if (lowerType.includes("tomahawk")) img = basePath + "tomahack001.jpg";
        else if (lowerType.includes("shuriken")) img = basePath + "shuriken001.jpg";
        else if (lowerType.includes("sarbacane")) img = basePath + "sarbacane001.jpg";
        else if (lowerType.includes("sansetsukon")) img = basePath + "sansetsukon001.jpg";
        else if (lowerType.includes("sabre")) img = basePath + "sabre001.jpg";
        else if (lowerType.includes("rapiere")) img = basePath + "rapière001.jpg";
        else if (lowerType.includes("nunchaku")) img = basePath + "nunchaku001.jpg";
        else if (lowerType.includes("morgenstern")) iimg = basePath + "masse001.jpg";
        else if (lowerType.includes("masse")) img = basePath + "masse001.jpg";
        else if (lowerType.includes("khopesh")) img = basePath + "khopesh001.jpg";
        else if (lowerType.includes("kama")) img = basePath + "boomerang001.jpg";
        else if (lowerType.includes("hache")) img = basePath + "hache001.jpg";
        else if (lowerType.includes("lance")) img = basePath + "lance001.jpg";
        else if (lowerType.includes("marteau")) img = basePath + "marteau001.jpg";
        else if (lowerType.includes("dague")) img = basePath + "dague001.jpg";
